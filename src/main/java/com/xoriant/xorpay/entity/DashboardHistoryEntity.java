...
@Table(name = "XP_DASHBOARD_DETAILS_H")
public class DashboardHistoryEntity {

	@Id
	//@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_D")
	//@SequenceGenerator(name="SEQ_D", sequenceName="SEQ_XP_DASHBOARD_DETAILS_SLNO", allocationSize=1)
